...
export const metadata: Metadata = {
  title: "이용약관",
  description: "테크밋(TechMeet) 서비스 이용약관입니다.",
      ...
      <div className="px-6 py-8 space-y-6 text-sm text-foreground leading-relaxed">
        ...
        <section id="definitions" className="scroll-mt-28">
          ...
          <div className="space-y-2 mt-2">
            <p>2-1. &quot;서비스&quot;란 회사가 제공하는 프리랜서 개발자 전용 프로젝트 매칭 플랫폼을 의미합니다.</p>
            <p>2-2. &quot;회원&quot;이란 서비스에 가입하여 이 약관에 동의한 자를 의미합니다.</p>
            <p>2-3. &quot;프로젝트&quot;란 회사가 등록하는 개발 업무 공고를 의미합니다.</p>
          </div>
        </section>
        ...
        <section id="usage" className="scroll-mt-28">
          ...
          <div className="space-y-2">
            ...
            <p>3-2. 회원은 카카오 계정을 통해 가입 및 로그인할 수 있습니다.</p>
            <p>3-3. 서비스는 프로젝트 조회, 지원, 프로필 관리 기능을 제공합니다.</p>
          </div>
        </section>
        ...
        <section id="obligations" className="scroll-mt-28">
          ...
          <div className="space-y-2">
            ...
            <p>4-2. 회원은 타인의 계정을 도용해서는 안 됩니다.</p>
            <p>4-3. 회원은 서비스를 이용하여 불법적인 행위를 해서는 안 됩니다.</p>
            <p>4-4. 회원은 회사의 사전 동의 없이 서비스를 이용하여 영업 활동을 할 수 없습니다.</p>
          </div>
        </section>
