  ...
  return (
    <div className="pb-6">
      ...
      <div className="px-4 py-6 min-h-[200px]">
        <p className="text-[15px] text-zinc-700 leading-loose whitespace-pre-wrap">
          {notice.content}
        </p>
      </div>
      ...
      <div className="border-t border-b divide-y divide-border">
        {newerNotice && (
          <Link href={`/notices/${newerNotice.id}`}>
            <div className="flex items-center gap-3 px-4 py-3.5 hover:bg-zinc-50 active:bg-zinc-100 transition-colors">
      ...
      <Link href="/">
        <div className="flex items-center justify-center gap-1.5 px-4 py-4 hover:bg-zinc-50 active:bg-zinc-100 transition-colors">
